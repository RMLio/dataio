...
public class CSVWSourceIterator2 extends SourceIterator {
    ...
    public CSVWSourceIterator2(Access access, CSVWConfiguration config) throws Exception {
        this.access = access;
        this.config = config;
        this.bootstrap();
    }
    ...
    private void bootstrap() throws Exception {
        this.reader = new CSVReaderBuilder(new InputStreamReader(access.getInputStream(), config.getEncoding()))
                .withCSVParser(this.config.getOpenCSVParser())
